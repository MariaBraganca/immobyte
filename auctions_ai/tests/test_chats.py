...
class TestOpenAiInteraction:
    @pytest.mark.asyncio
    async def test_add_user_message_for_success(self, patched_openai, assisted_user_chat, caplog):
    ...
    @pytest.mark.asyncio
    async def test_run_assistant_for_success(self, patched_openai, assisted_user_chat, caplog):
    ...
    @pytest.mark.asyncio
    async def test_retrieve_assistant_for_success(self, patched_openai, assisted_user_chat, caplog):
    ...
    @pytest.mark.asyncio
    async def test_read_thread_messages_for_success(self, patched_openai, assisted_user_chat, caplog):
    ...
    @pytest.mark.asyncio
    @pytest.mark.parametrize('exception,expected,log_message', [
        (openai.APIConnectionError(request = MagicMock()), None, "The server could not be reached"),
        (openai.RateLimitError(message = '', response = MagicMock(), body = None), None, "A 429 status code was received; we should back off a bit."),
        (openai.APIStatusError(message = '', response = MagicMock(), body = None), None, "Another non-200-range status code was received"),
    ])
    async def test_add_user_message_for_failure(self, patched_openai, assisted_user_chat, exception, expected, log_message, caplog):
    ...
    async def test_run_assistant_for_failure(self, patched_openai, assisted_user_chat, exception, expected, log_message, caplog):
    ...
    async def test_retrieve_assistant_for_failure(self, patched_openai, assisted_user_chat, exception, expected, log_message, caplog):
    ...
    async def test_read_thread_messages_for_failure(self, patched_openai, assisted_user_chat, exception, expected, log_message, caplog):
