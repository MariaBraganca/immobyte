...
async def test_call_assister_user_chat(patched_openai, assisted_user_chat, processed_response, parsed_response, expected):
...
async def test_process_assistant_response(patched_openai, assisted_user_chat, run_object, run_status_completed, expected, log_message, caplog):
...
async def test_check_status_completed(patched_openai, assisted_user_chat, run_object, run_status, expected, await_count, log_messages, caplog):
...
async def test_parse_assistant_response(patched_openai, assisted_user_chat, thread_messages_object, expected, log_messages, caplog):
...
# TODO's:
# expanded error scenario coverage (log openai error decorator)
